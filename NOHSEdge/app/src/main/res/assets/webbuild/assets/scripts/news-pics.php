...
*/
	...
	foreach($array['channel']['item'] as $item) {
		...
		echo '<div class="news-item link-track" data-url="'.$item['link'].'" data-title="News" data-eid="0" style="background: #000 url('.((!$item['enclosure']['@attributes']['url']) ? 'assets/img/custom/tutorial-home.png' : $item['enclosure']['@attributes']['url'] ) .') center center no-repeat; background-size: cover;"><div class="shadow"></div><p>'.$item['title'].' →</p>';
